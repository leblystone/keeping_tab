...
export const BUNDLES: Bundle[] = [
  {
    ...
    cardIds: [
      ...
      "v1-p11", "v1-p12", "v1-p13", "v1-p14", "v1-p15", "v1-p16", "v1-p17", "v1-p18", "v1-p19", "v1-p20",
      "v1-p21", "v1-p22", "v1-p23", "v1-p24", "v1-p25", "v1-p26", "v1-p27", "v1-p28", "v1-p29", "v1-p30",
      "v1-p31", "v1-p32", "v1-p33", "v1-p34", "v1-p35", "v1-p36", "v1-p37", "v1-p38", "v1-p39", "v1-p40",
      "v1-p41", "v1-p42", "v1-p43", "v1-p44", "v1-p45", "v1-p46", "v1-p47", "v1-p48", "v1-p49", "v1-p50",
    ],
  },
  {
    id: "catalog-v2",
    ...
    accent: "violet",
    cardIds: [
      "v2-p02", "v2-p03", "v2-p04", "v2-p05", "v2-p06", "v2-p07", "v2-p08", "v2-p09", "v2-p10", "v2-p11",
      "v2-p12", "v2-p13", "v2-p14", "v2-p15", "v2-p16", "v2-p17", "v2-p18", "v2-p19", "v2-p20", "v2-p21",
      "v2-p22", "v2-p23", "v2-p24", "v2-p25", "v2-p26", "v2-p27", "v2-p28", "v2-p29", "v2-p30", "v2-p31",
      "v2-p32", "v2-p33", "v2-p34", "v2-p35", "v2-p36", "v2-p37", "v2-p38", "v2-p39", "v2-p40", "v2-p41",
      "v2-p42", "v2-p43", "v2-p44", "v2-p45", "v2-p46", "v2-p47", "v2-p48", "v2-p49", "v2-p50",
    ],
  },
  {
    id: "free-starter",
  ...
  },
  {
    ...
    accent: "sky",
    cardIds: [
      "v1-p34", "v1-p35", "v1-p36", "v1-p37", "v1-p38", "v1-p39",
      "v1-p40", "v1-p41", "v1-p42", "v1-p43", "v1-p44", "v1-p45",
    ],
  },
  {
    id: "free-foodie",
    ...
    accent: "rose",
    cardIds: [
      "v1-p07", "v1-p14", "v1-p16", "v1-p20", "v1-p28",
      "v1-p29", "v1-p30", "v1-p32", "v1-p33", "v1-p49",
    ],
  },
  {
    id: "paid-spooky",
